                            ...
                            <tr key={post.id}>
                                ...
                                <td>
                                    <div className="btn-group">
                                        <button onClick={(event)=>this.edit(event, post)} className="btn btn-warning">Edit</button>
                                        <button onClick={(e)=>this.delete(e, post.id)} className="btn btn-danger">Delete</button>
                                    </div>
                                </td>
                            </tr>
                            )}
